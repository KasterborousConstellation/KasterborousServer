...
public class Classification {
    private final static Material[] ironTool= new Material[]{Material.IRON_AXE,Material.IRON_SWORD,Material.IRON_SPADE,Material.IRON_PICKAXE,Material.IRON_HOE};
    private final static Material[] diamondTool= new Material[]{Material.DIAMOND_AXE,Material.DIAMOND_SWORD,Material.DIAMOND_SPADE,Material.DIAMOND_PICKAXE,Material.DIAMOND_HOE};
